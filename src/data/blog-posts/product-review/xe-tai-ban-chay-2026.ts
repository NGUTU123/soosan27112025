...
export const xeTaiBanChay2025: BlogPost = {
  ...
  content: `
    <div class="prose-content">
      ...
      <p>Năm 2026 đã chứng kiến sự phát triển mạnh mẽ của thị trường xe tải tại Việt Nam. Với nhu cầu vận chuyển hàng hóa ngày càng tăng cao, các dòng xe tải chất lượng cao đã chiếm được lòng tin của khách hàng.</p>
